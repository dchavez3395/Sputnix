...
const Raptor = () => {
  return (
    <>
    <div className='relative bg-black py-20 lg:py-12'>
        <div className='z-[0]'>
            <img src="https://raw.githubusercontent.com/dchavez3395/sputnik-v2/main/assets/Mothership/Raptor.webp" className='w-full h-[50vh] lg:h-screen object-cover' alt=""  />
        </div>
            {/* rocket info */}
        <div className="lg:absolute z-[0] px-8 lg:pt-[10%] xl:pt-[5%] lg:px-0 m-auto text-white text-left lg:w-1/5 top-[20%] lg:left-[15%] 2xl:left-[20%]">

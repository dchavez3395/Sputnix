...
import { rocketSlider } from '../data/data.js'
import 'swiper/css'
        ...
        {rocketSlider.map((slide, index) => {
          ...
          return (
            <SwiperSlide key={index}>
              ...
              {/* rocket info */}
                  <div className="lg:absolute z-[0] pt-12 md:py-20 lg:py-0 px-8 md:px-48 lg:px-0 xl:w-[30rem] text-white text-left top-[25%] left-[-10%] lg:left-[15%] 2xl:left-[25%]">

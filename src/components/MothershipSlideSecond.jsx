  ...
  return (
    <>
        <div>
            ...
            <div className=' z-[0]'>
                    <img src='	https://www.spacex.com/static/images/starship/desktop/WebsiteStarship_Render_Desktop.webp' className='w-full h-[50vh] lg:h-[100vh] object-cover' alt=""  />
                </div>
                    {/* rocket info */}
                <div className="lg:absolute z-[0] px-8 md:px-32 py-12 lg:px-0 text-white text-left top-[20%] lg:left-[15%] 2xl:left-[20%]">

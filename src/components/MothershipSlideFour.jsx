...
import {mothershipPayload} from "../data/data"
        ...
        <div>
            <div className='relative bg-black'>
                <div className=' z-[0]'>
                    ...
                    {/* rocket info */}
                <div className="lg:absolute z-[0] px-8 py-12 md:px-32 lg:px-0 text-white text-center lg:text-left top-[20%] lg:left-[10%] 2xl:left-[20%]">
                    <h3 className='text-2xl '>MOTHERSHIP</h3>
                    <h1 className="text-[40px] 2xl:text-6xl py-2  font-bold uppercase">PAYLOAD</h1>
                    {/* table */}
                    ...
                    return (
                        ...
                        <table className="w-full lg:w-[28rem] text-left">
                            <tbody className=" text-[15.5px] w-full font-[600] ">

    ...
    <div>
        {/*Carrousell */}
            ...
            {/* first slide */}
              ...
              <div>
                ...
                <video className="z-[0] w-full relative h-[50vh] lg:h-screen object-cover " autoPlay loop muted>
                    <source className="w-full h-full object-cover" src='https://www.spacex.com/media/WebsiteFHFairings_Anim_Render_Desktop.mp4' />
                </video>
              {/* rocket info */}
            ...
            <div className='relative'>
                <div className=' z-[0]'>
                     <img src='https://www.spacex.com/static/images/falcon-heavy/desktop/WebsiteFHSoloFairings_Render_Desktop.webp' className='w-full h-[50vh] lg:h-[100vh] object-cover' alt=""  />
                </div>
              {/* rocket info */}

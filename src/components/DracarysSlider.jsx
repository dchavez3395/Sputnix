    ...
    <div>
        {/*Carrousell */}
            ...
            <div className='relative py-12' key='id'>
                <div className=' z-[0]'>
                     <img src="https://www.spacex.com/static/images/dragon/desktop/DragonTrunk_Render_Desktop.webp" className='w-full h-[50vh] lg:h-[100vh]  object-cover' alt=""  />
                </div>
              {/* rocket info */}
                <div className="lg:absolute z-[0] px-4 py-12 m-auto  lg:px-0 w-full md:px-32 xl:w-2/6 2xl:w-1/4 text-white text-center lg:text-left top-[15%] lg:top-[25%] 2xl:top-[15%] lg:left-[15%] 2xl:left-[20%]">
                    <h3 className='text-xl '>DRACARYS</h3>
                    <h1 className="text-[40px] 2xl:text-5xl py-2  font-bold uppercase">TRUNK</h1>

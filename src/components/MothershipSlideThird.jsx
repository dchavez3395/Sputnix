    ...
    <div>
        <div>
            <div className='relative bg-black'>
                <div className=' z-[0]'>
                    <img src='https://www.spacex.com/static/images/starship/desktop/WebsiteSuperHeavy_Render_Desktop.webp' className='w-full h-[50vh] lg:h-[100vh] object-cover' alt=""  />
                </div>
                    {/* rocket info */}
                <div className="lg:absolute z-[0] px-8 md:px-32 py-12 lg:px-0 text-white text-left top-[20%] lg:left-[15%] 2xl:left-[25%]">
                    <h1 className="text-[40px] 2xl:text-5xl py-4  font-bold uppercase" data-aos='fade-right' data-aos-delay='700'>SUPER HEAVY</h1>
                    {/* table */}
                    <div>
                    </div>

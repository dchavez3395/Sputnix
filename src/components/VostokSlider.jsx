            ...
            {/* first slide */}
              <SwiperSlide>
                ...
                <video className="z-[0] w-full relative h-[50vh] lg:h-screen object-cover " autoPlay loop muted>
                    <source className="w-full" src='https://www.spacex.com/media/WebsiteF9Fairings_Anim_Render_Desktop.mp4' />
                </video>
              {/* rocket info */}
                <div className="lg:absolute z-[0] py-12 px-8 md:px-48 lg:px-0 text-white text-left top-[25%] left-[-10%] lg:left-[15%] 2xl:left-[25%]">
